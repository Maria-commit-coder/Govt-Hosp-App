  ...
  render() {
    ...
    <Card>
      ...
      <View style={{flexDirection:"row",marginTop:"15%",}}>
        <Icon name="inr" style={{marginRight:"3%"}} size={18}/>
        <Text style={{fontSize:12,color:"grey"}}>
        Fee charged: 250
      </Text>
      </View>
      <View style={{flexDirection:"row"}}>
        <Icon name="calendar" style={{marginTop:"2%",marginRight:"2%"}} size={15}/>
        
      <Text style={{fontSize:12,marginBottom:"2%",color:"grey"}}>
        Timings available: {'\n'}
        Mon - Sat{'\n'}
        06:30AM to 09:30PM
      </Text>
      ...
      <Icon name='star' size={18} color={'gold'}/>
       ...
       <Icon name='star' size={18} color={'gold'}/>
       <Icon name='star' size={18} color={'gold'}/>
       <Icon name='star-o' size={18} color={'gold'}/></View>
    
      </View>
      </CardItem>
      <CardItem>
      <Button style={{width:"50%", backgroundColor:'rgb(65,204,201)',marginTop:"1.5%", borderRadius:19,marginRight:"1%"}}
          onPress={this.props.navigatetoReviewDoctorComponent}>
            <Text style={{marginLeft:"20%",color:"white",fontSize:15, marginTop:'-2%'}}>Review Doctor</Text>
          </Button>
          <Button style={{width:"50%", backgroundColor:'rgb(65,204,201)',marginTop:"1.5%", borderRadius:19}}
          onPress={this.props.navigatetoReviewDoctorComponent}>
            <Text style={{marginLeft:"10%",color:"white",fontSize:15, marginTop:'-2%'}}>Take Appointment</Text>
          </Button>
      </CardItem>
    </Card>
    <Card>
