...
export default class ReviewHospitalComponent extends Component {
  
  render() {
    return (
      <ScrollView style={{backgroundColor:'rgba(65,204,201,0.2)', flex:1}}>
        <Text style={{marginTop:'2%', fontSize:17}}>Please read the following questions and rate the hospital.</Text>
        ...
        <CardItem bordered>
          ...
          <CardItem>
            <TouchableOpacity onPress={this.props.navigatetoReviewDoctorComponent}>
              <Text style={{color:'rgb(65,204,201)',fontSize:17, fontWeight:'bold'}}>Rate doctor?</Text>
            </TouchableOpacity>
          </CardItem>
